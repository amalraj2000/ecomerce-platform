                ...
                <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
                    <div class="flex h-16 justify-between">
                        <div class="flex">
                            ...
                            >
                                <NavLink
                                    :href="route($page.props.auth.user.role === 'admin' ? 'admin.dashboard' : ($page.props.auth.user.role === 'vendor' ? 'vendor.dashboard' : 'dashboard'))"
                                ...
                                <template v-if="$page.props.auth.user.role === 'admin'">
                                    <NavLink :href="route('admin.categories.index')" :active="route().current('admin.categories.*')">Categories</NavLink>
                                    <NavLink :href="route('admin.products.index')" :active="route().current('admin.products.*')">Products</NavLink>
                                    <NavLink :href="route('admin.vendors.index')" :active="route().current('admin.vendors.index') || route().current('admin.vendors.show') || route().current('admin.vendors.edit')">Vendors</NavLink>
                                ...
                                <!-- User Modules -->
                                <template v-else>
                                    <NavLink :href="route('user.orders')" :active="route().current('user.orders')">Orders</NavLink>
                                    <NavLink :href="route('addresses.index')" :active="route().current('addresses.*')">Addresses</NavLink>
                                </template>
                            </div>
                        </div>
                ...
                >
                    <div class="space-y-1 pb-3 pt-2">
                        ...
                        <template v-if="$page.props.auth.user.role === 'admin'">
                            ...
                            <ResponsiveNavLink :href="route('admin.products.index')" :active="route().current('admin.products.*')">Products</ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('admin.vendors.index')" :active="route().current('admin.vendors.index') || route().current('admin.vendors.show') || route().current('admin.vendors.edit')">Vendors</ResponsiveNavLink>
                        ...
                        <template v-else>
                            <ResponsiveNavLink :href="route('user.orders')" :active="route().current('user.orders')">Orders</ResponsiveNavLink>
                            <ResponsiveNavLink :href="route('addresses.index')" :active="route().current('addresses.*')">Addresses</ResponsiveNavLink>
                        </template>
                    </div>
